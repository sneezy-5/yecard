...
class ForgotPassworCodedScreen extends StatefulWidget {
  const ForgotPassworCodedScreen({Key? key}) : super(key: key);

  @override
  _ForgotPasswordCodeScreenState createState() => _ForgotPasswordCodeScreenState();
}

class _ForgotPasswordCodeScreenState extends State<ForgotPassworCodedScreen> {
  String? token;
